        ...
        if callable(attribute):
            ...
            async def wrapped_method(*args, **kwargs):
                try:
                    ...
                    self.log.error(Text("Mastodon API Worker encountered an error", style="red"))
                    raise e
                else:
                    self.log(Text("Mastodon API Worker completed successfully", style="green"))
...
class APIRunner(DOMNode):
    ...
    @work(thread=True, exit_on_error=False, group="api_call")    
